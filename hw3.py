...
def family_comparison(f1, f2):
    ...
    return 'Equal' if len(family_1_arr) == len(family_2_arr) else family_1_arr if len(family_1_arr) > len(
        family_2_arr) else family_2_arr
...
film = {'title': 'House M.D.', 'director': 'David Shore', 'year': '2004–2012', 'budget': 'unknown',
